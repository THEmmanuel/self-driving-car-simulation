...
const traffic = [
	...
	new Car(road.getLaneCenter(0), -300, 30, 50, 'NO_KEYS', 2),
	new Car(road.getLaneCenter(2), -300, 30, 50, 'NO_KEYS', 2),
	new Car(road.getLaneCenter(0), -500, 30, 50, 'NO_KEYS', 2),
	new Car(road.getLaneCenter(1), -500, 30, 50, 'NO_KEYS', 2),
	new Car(road.getLaneCenter(1), -700, 30, 50, 'NO_KEYS', 2),
	new Car(road.getLaneCenter(2), -700, 30, 50, 'NO_KEYS', 2),
